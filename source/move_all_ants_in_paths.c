...
/*
** if one_pos has not added ant (in all the nodes in a loop) and last_ant == 0, then dont print "\n" and ont increment count. Instead increment var x = 0 in lemin->lines - (count - x). !
*/
